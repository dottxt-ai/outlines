...
from outlines.inputs import AssistantMessage, Chat, Image
    ...
    def _handle_streaming_response(
        ...
        for chunk in stream:
            ...
            if delta.tool_calls:
                ...
                yield StreamingOutput(type="assistant", content=delta.content)
...
def _handle_openai_response(
...
) -> AssistantMessage | List[AssistantMessage]:
    """Convert the response from the OpenAI API to an AssistantMessage or a
    list of AssistantMessages.
    ...
    -------
    AssistantMessage | List[AssistantMessage]
        The AssistantMessage or list of AssistantMessages.
    ...
    for message in messages:
        ...
        if message.tool_calls:
            ...
            outputs.append(Output(type="assistant", content=message.content))
