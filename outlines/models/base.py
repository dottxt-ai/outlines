...
class ModelTypeAdapter(ABC):
    ...
    @abstractmethod
    def format_output_type(self, output_type: Optional[Any]) -> Any:
    ...
    def format_tools(self, tools: Optional[List[ToolDef]]) -> Optional[list]:
        ...
        ----------
        tools
            A list of tools to format.

        Returns
        -------
        Optional[list]
            The formatted tools to be passed to the model. If no tools are
...
class Model(ABC):
    ...
    def __call__(
        ...
        **inference_kwargs: Any
        ...
        tools
            A list of tools to provide to the model. Can contain an MCPServer,
        ...
        **inference_kwargs
        ...
        return Generator(self, output_type, backend, tools=tools)(model_input, **inference_kwargs) # type: ignore
    ...
    def stream(
        ...
        **inference_kwargs
        ...
        -------
        Iterator[StreamingOutput]
            A stream of StreamingOutput produced by the model.
...
class AsyncModel(ABC):
    ...
    async def __call__(
        ...
        **inference_kwargs
        ...
        generator = Generator(self, output_type, backend, tools=tools)
        return await generator(model_input, **inference_kwargs) # type: ignore
