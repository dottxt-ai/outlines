...
class OutlinesEncodingBuffer:
    ...
    This is a modified version of Mako's `FastEncodingBuffer`. It build outlines graph when the template is rendered with

    It allows to
    build Outlines graph when rendering Mako templates that contain
    `StringVariable`s.
