...
class RegexGuide(Guide):
    ...
    def __init__(self, regex_string: str, tokenizer):
        @cache()
        def create_states_mapping(regex_string: str, tokenizer_name_or_path: str) -> Tuple[dict, set, set]:
        ...
        (
            ...
            fsm_finals,
        ) = create_states_mapping(regex_string, tokenizer.tokenizer_name_or_path)
        self.eos_token_id = tokenizer.eos_token_id
