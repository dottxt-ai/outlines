...
class BlackBoxGenerator:
    ...
    def __init__(
        ...
        *,
        ...
        tools
            A list of tools to use for the generator. Can contain a list of
            ToolDef, Callable, or BaseModel instances.
...
class SteerableGenerator:
    ...
    def __init__(
        ...
        *,
        ...
        """
        self.model = model
        # tools are not implemented yet for steerable models
        # error is raised within each model's type_adapter
        self.tools = get_formatted_tools(tools)
