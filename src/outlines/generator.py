...
class BlackBoxGenerator:
    ...
    def batch(self, prompts: List[Any], **inference_kwargs) -> List[Any]:
        ...
        **inference_kwargs
        ...
        """
        return self.model.generate_batch(prompts, self.output_type, **inference_kwargs)
    ...
    def __init__(
        ...
        if output_type is None:
            ...
            self.logits_processor = get_logits_processor(
                output_type, model, backend_name
            )

    @classmethod
    def from_processor(cls, model: SteerableModel, processor: LogitsProcessorType):
...
def Generator(
    ...
    *,
    ...
    provided_output_params = sum(
        param is not None for param in [output_type, processor]
    )
