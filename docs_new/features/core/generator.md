...
- Similarly, some models do not support streaming
- On top the prompt, the generator's call/stream methods accept inference kwargs that are passed on to the inference model Outlines wraps. Check the documentation of the inference library in question to find what arguments to use
