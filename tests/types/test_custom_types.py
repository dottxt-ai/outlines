...
@pytest.mark.parametrize(
    ...
    [
        ...
        (types.locale.fr.phone_number, "12", False),
        (types.locale.fr.phone_number, "0612345678", True),
        (types.locale.fr.phone_number, "+33 6 12 34 56 78", True),
        (types.locale.fr.phone_number, "0123456789", True),
        (types.locale.fr.postal_code, "12", False),
        (types.locale.fr.postal_code, "75001", True),
        (types.locale.fr.postal_code, "01000", True),
        (types.locale.fr.postal_code, "59000", True),
        (types.locale.fr.postal_code, "97100", True),
        (types.locale.fr.postal_code, "98000", True),
        (types.locale.fr.postal_code, "99000", False),
