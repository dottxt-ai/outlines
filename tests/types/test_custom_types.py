...
@pytest.mark.parametrize(
    ...
    [
        ...
        (types.locale.uk.phone_number, "12", False),
        (types.locale.uk.phone_number, "+44 7911 123456", True),
        (types.locale.uk.phone_number, "07911 123456", True),
        (types.locale.uk.postcode, "12", False),
        (types.locale.uk.postcode, "SW1A 2AA", True),
        (types.locale.uk.postcode, "EC1A1BB", True),
        (types.locale.ca.phone_number, "12", False),
        (types.locale.ca.phone_number, "(416) 555-1234", True),
        (types.locale.ca.phone_number, "+1 416 555 1234", True),
        (types.locale.ca.postal_code, "12", False),
        (types.locale.ca.postal_code, "K1A0A6", True),
        (types.locale.ca.postal_code, "K1A 0A6", True),
