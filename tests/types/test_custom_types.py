...
@pytest.mark.parametrize(
    ...
    [
        ...
        (types.locale.au.phone_number, "12", False),
        (types.locale.au.phone_number, "+61 412 345 678", True),
        (types.locale.au.phone_number, "0412 345 678", True),
        (types.locale.au.phone_number, "+61 2 9876 5432", True),
        (types.locale.au.phone_number, "02 9876 5432", True),
        (types.locale.au.postcode, "12", False),
        (types.locale.au.postcode, "2000", True),
        (types.locale.au.postcode, "3000", True),
        (types.locale.au.postcode, "0800", True),
