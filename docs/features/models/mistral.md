...
You can also use chat inputs with the `Mistral` model. To do so, call the model with a `Chat` instance. The content of message within the chat can be vision inputs as described above.
